...
void nr_rrc_config_dl_tda(struct NR_PDSCH_TimeDomainResourceAllocationList *pdsch_TimeDomainAllocationList,
  ...
  *timedomainresourceallocation->k0 = 0;
  ...
  timedomainresourceallocation1->k0 = calloc(1,sizeof(*timedomainresourceallocation1->k0));
  *timedomainresourceallocation1->k0 = 0;
  ...
  if(frame_type==TDD) {
    ...
    if(tdd_UL_DL_ConfigurationCommon) {
      ...
      if(dl_symb > 1) {
        ...
        timedomainresourceallocation2->k0 = calloc(1,sizeof(*timedomainresourceallocation2->k0));
        *timedomainresourceallocation2->k0 = 0;
...
NR_BCCH_BCH_Message_t *get_new_MIB_NR(const NR_ServingCellConfigCommon_t *scc)
{
  ...
  mib->message.choice.mib->intraFreqReselection = NR_MIB__intraFreqReselection_allowed;
  return mib;
}
...
NR_MeasurementTimingConfiguration_t *get_new_MeasurementTimingConfiguration(const NR_ServingCellConfigCommon_t *scc)
{
  ...
  ssb_mtc->duration = NR_SSB_MTC__duration_sf5;
                                      ...
                                      const nr_mac_timers_t *timer_config)
{
  ...
  sib1->cellSelectionInfo->q_QualMin = calloc(1,sizeof(*sib1->cellSelectionInfo->q_QualMin));
  *sib1->cellSelectionInfo->q_QualMin = -43;
  ...
  *ZoneEight = 0;
  #else
  /*As paging search space = 0,Hence setting SIB1 pcch config as assigned below according to SS/PBCH and CORESET multiplexing pattern 1. [TS 38.304]*/
  ServCellCom->downlinkConfigCommon.pcch_Config.defaultPagingCycle = NR_PagingCycle_rf128;
  ServCellCom->downlinkConfigCommon.pcch_Config.nAndPagingFrameOffset.present = NR_PCCH_Config__nAndPagingFrameOffset_PR_oneT;
  ServCellCom->downlinkConfigCommon.pcch_Config.nAndPagingFrameOffset.choice.oneT = 0;
  ServCellCom->downlinkConfigCommon.pcch_Config.ns = NR_PCCH_Config__ns_one;
  #endif
  ...
  asn1cCallocOne(sib1->ims_EmergencySupport, NR_SIB1__ims_EmergencySupport_true);

  // eCallOverIMS-Support
  // TODO: add eCallOverIMS-Support
  asn1cCallocOne(sib1->eCallOverIMS_Support, NR_SIB1__eCallOverIMS_Support_true);
                                                  ...
                                                  const nr_mac_config_t *configuration)
{
  ...
  NR_RLC_BearerConfig_t *rlc_BearerConfig =
      get_SRB_RLC_BearerConfig(1, 1, NR_LogicalChannelConfig__ul_SpecificParameters__bucketSizeDuration_ms50); 
