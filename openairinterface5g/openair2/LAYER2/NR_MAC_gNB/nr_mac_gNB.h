...
#ifdef UNI_RAN
#define MAX_PCCH_PDU_SIZE 128 //(Paging PDU SIZE)
#endif
...
typedef struct {
  ...
  void (*unset)(void **);
  int (*run)(
      module_id_t, frame_t, sub_frame_t, NR_UE_info_t **, int, int ,int *, void *);
  void *data;
} nr_dl_sched_algo_t;
...
typedef struct gNB_MAC_INST_s {
  ...
  #ifdef UNI_RAN
  /* Paging Info */
  uint8_t  pcch_pdu[MAX_PCCH_PDU_SIZE];
  int      pcch_pdu_size;
  bool     pcch_pending;
  #endif
