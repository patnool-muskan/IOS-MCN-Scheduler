 ...
 */
int get_asn1c_environment_version_e2ap_v3_01() { return ASN1C_ENVIRONMENT_VERSION; }
 ...
 */
ber_tlv_tag_t
asn_TYPE_outmost_tag_e2ap_v3_01(const asn_TYPE_descriptor_t *type_descriptor,
 ...
 */
int
asn_fprint_e2ap_v3_01(FILE *stream, const asn_TYPE_descriptor_t *td,
...
void ASN_DEBUG_f_e2ap_v3_01(const char *fmt, ...) {
	va_list ap;
	va_start(ap, fmt);
