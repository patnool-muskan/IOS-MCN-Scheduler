...
SET_OF_random_fill_e2ap_v3_01(const asn_TYPE_descriptor_t *td, void **sptr,
                   const asn_encoding_constraints_t *constraints,
                   size_t max_length) {
    const asn_SET_OF_specifics_t *specs =
        (const asn_SET_OF_specifics_t *)td->specifics;
    asn_random_fill_e2ap_v3_01_result_t res_ok = {ARFILL_OK, 0};
    ...
    switch(asn_random_between_e2ap_v3_01(0, 6)) {
    ...
    switch(asn_random_between_e2ap_v3_01(-1, 4)) {
    default:
    case -1:
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
        ...
        if(constraints->per_constraints
           && (constraints->per_constraints->size.flags & APC_EXTENSIBLE)) {
            ...
            case 1:
                ...
                break;
            case 2:
                rnd_len = asn_random_between_e2ap_v3_01(0, slb);
                break;
            case 3:
            ...
            case 4:
                if(sub < (ssize_t)max_length) {
                    rnd_len = asn_random_between_e2ap_v3_01(sub + 1, max_length);
                } else {
                    rnd_len = max_length;
                }
                break;
        ...
        /* Fall through */
    case 0:
        rnd_len = asn_random_between_e2ap_v3_01(slb, sub);
        break;
    case 1:
        if(slb < sub) {
            rnd_len = asn_random_between_e2ap_v3_01(slb + 1, sub);
            break;
        }
        /* Fall through */
    case 2:
        rnd_len = asn_random_between_e2ap_v3_01(slb, slb);
        break;
    case 3:
        if(slb < sub) {
            rnd_len = asn_random_between_e2ap_v3_01(slb, sub - 1);
            break;
        }
        /* Fall through */
    case 4:
        rnd_len = asn_random_between_e2ap_v3_01(sub, sub);
        break;
    }
    ...
    for(; rnd_len > 0; rnd_len--) {
        ...
        void *ptr = 0;
        asn_random_fill_e2ap_v3_01_result_t tmpres = elm->type->op->random_fill(
