 ...
 */
asn_dec_rval_t xer_decode_e2ap_v3_01(
 ...
 * Used by more specialized functions, such as OCTET_STRING_decode_xer_utf8_e2ap_v3_01
 * and others. This function should not be used by applications, as its API
 * is subject to changes.
 */
asn_dec_rval_t xer_decode_e2ap_v3_01_general(
    const asn_codec_ctx_t *opt_codec_ctx,
...
ssize_t xer_next_token_e2ap_v3_01(int *stateContext,
	const void *buffer, size_t size, pxer_chunk_type_e *_ch_type);

/*
 * This function checks the buffer against the tag name is expected to occur.
 */
  typedef enum xer_check_tag_e2ap_v3_01 {
...
xer_check_tag_e2ap_v3_01_e xer_check_tag_e2ap_v3_01(const void *buf_ptr, int size,
		const char *need_tag);
 ...
 */
size_t xer_whitespace_span_e2ap_v3_01(const void *chunk_buf, size_t chunk_size);

/*
 * Skip the series of anticipated extensions.
 */
int xer_skip_unknown_e2ap_v3_01(xer_check_tag_e2ap_v3_01_e tcv, ber_tlv_len_t *depth);
