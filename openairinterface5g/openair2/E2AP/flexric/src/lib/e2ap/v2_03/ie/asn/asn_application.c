...
static asn_enc_rval_t asn_encode_e2ap_v2_03_internal(const asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t
asn_encode_e2ap_v2_03(const asn_codec_ctx_t *opt_codec_ctx,
    ...
    er = asn_encode_e2ap_v2_03_internal(opt_codec_ctx, syntax, td, sptr,
...
asn_enc_rval_t
asn_encode_e2ap_v2_03_to_buffer(const asn_codec_ctx_t *opt_codec_ctx,
                     enum asn_transfer_syntax syntax,
    ...
    if(er.encoded >= 0 && (size_t)er.encoded != buf_key.computed_size) {
        ASN_DEBUG("asn_encode_e2ap_v2_03() returned %" ASN_PRI_SSIZE
...
asn_encode_e2ap_v2_03_to_new_buffer_result_t
asn_encode_e2ap_v2_03_to_new_buffer(const asn_codec_ctx_t *opt_codec_ctx,
                         enum asn_transfer_syntax syntax,
                         const asn_TYPE_descriptor_t *td, const void *sptr) {
    struct dynamic_encoder_key buf_key;
    asn_encode_e2ap_v2_03_to_new_buffer_result_t res;

    buf_key.buffer_size = 16;
    buf_key.buffer = MALLOC(buf_key.buffer_size);
    buf_key.computed_size = 0;

    res.result = asn_encode_e2ap_v2_03_internal(opt_codec_ctx, syntax, td, sptr,
...
asn_encode_e2ap_v2_03_internal(const asn_codec_ctx_t *opt_codec_ctx,
                    enum asn_transfer_syntax syntax,
                    const asn_TYPE_descriptor_t *td, const void *sptr,
                    asn_app_consume_bytes_f *callback, void *callback_key) {
    asn_enc_rval_t er = {0,0,0};
#if !defined(ASN_DISABLE_XER_SUPPORT)
    enum xer_encode_e2ap_v2_03r_flags_e xer_flags = XER_F_CANONICAL;
    ...
    case ATS_BER:
        ...
        /* Fall through. */
    case ATS_DER:
        if(td->op->der_encode_e2ap_v2_03r) {
            er = der_encode_e2ap_v2_03(td, sptr, callback, callback_key);
            if(er.encoded == -1) {
                if(er.failed_type && er.failed_type->op->der_encode_e2ap_v2_03r) {
                    errno = EBADF;   /* Structure has incorrect form. */
                } else {
    ...
    case ATS_UNALIGNED_CANONICAL_PER:
        if(td->op->uper_encode_e2ap_v2_03r) {
            er = uper_encode_e2ap_v2_03(td, 0, sptr, callback, callback_key);
            if(er.encoded == -1) {
                if(er.failed_type && er.failed_type->op->uper_encode_e2ap_v2_03r) {
                    errno = EBADF;   /* Structure has incorrect form. */
                } else {
    ...
    case ATS_ALIGNED_CANONICAL_PER:
        if(td->op->aper_encode_e2ap_v2_03r) {
            er = aper_encode_e2ap_v2_03(td, 0, sptr, callback, callback_key);
            if(er.encoded == -1) {
                if(er.failed_type && er.failed_type->op->aper_encode_e2ap_v2_03r) {
                    errno = EBADF;   /* Structure has incorrect form. */
                } else {
    ...
    case ATS_CANONICAL_XER:
        if(td->op->xer_encode_e2ap_v2_03r) {
            er = xer_encode_e2ap_v2_03(td, sptr, xer_flags, callback, callback_key);
            if(er.encoded == -1) {
                if(er.failed_type && er.failed_type->op->xer_encode_e2ap_v2_03r) {
                    errno = EBADF;   /* Structure has incorrect form. */
                } else {
...
asn_dec_rval_t
asn_decode_e2ap_v2_03(const asn_codec_ctx_t *opt_codec_ctx,
           enum asn_transfer_syntax syntax, const asn_TYPE_descriptor_t *td,
    ...
    case ATS_RANDOM:
        ...
        if(!td->op->random_fill) {
            ...
            if(asn_random_fill_e2ap_v2_03(td, sptr, 16000) == 0) {
    ...
    case ATS_BER:
#if !defined(ASN_DISABLE_BER_SUPPORT)
        return ber_decode_e2ap_v2_03(opt_codec_ctx, td, sptr, buffer, size);
#else
        errno = ENOENT;
        ASN__DECODE_FAILED;
#endif  /* !defined(ASN_DISABLE_BER_SUPPORT) */
    ...
    case ATS_UNALIGNED_CANONICAL_PER:
#if !defined(ASN_DISABLE_UPER_SUPPORT)
        return uper_decode_e2ap_v2_03_complete(opt_codec_ctx, td, sptr, buffer, size);
#else
        errno = ENOENT;
        ASN__DECODE_FAILED;
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) */
    ...
    case ATS_ALIGNED_CANONICAL_PER:
#if !defined(ASN_DISABLE_APER_SUPPORT)
        return aper_decode_e2ap_v2_03_complete(opt_codec_ctx, td, sptr, buffer, size);
#else
        errno = ENOENT;
        ASN__DECODE_FAILED;
#endif  /* !defined(ASN_DISABLE_APER_SUPPORT) */
    ...
    case ATS_CANONICAL_XER:
#if !defined(ASN_DISABLE_XER_SUPPORT)
        return xer_decode_e2ap_v2_03(opt_codec_ctx, td, sptr, buffer, size);
#else
        errno = ENOENT;
        ASN__DECODE_FAILED;
#endif  /* !defined(ASN_DISABLE_XER_SUPPORT) */
