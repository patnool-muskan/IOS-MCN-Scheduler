...
asn_dec_rval_t
NativeEnumerated_decode_aper_e2ap_v2_03(const asn_codec_ctx_t *opt_codec_ctx,
    ...
    if(ct && ct->range_bits >= 0) {
        ...
        value = aper_get_nsnnwn_e2ap_v2_03(pd, 65537);
        if(value < 0) ASN__DECODE_STARVED;
...
asn_enc_rval_t
NativeEnumerated_encode_aper_e2ap_v2_03(const asn_TYPE_descriptor_t *td,
                             const asn_per_constraints_t *constraints,
    ...
    if(aper_put_nsnnwn_e2ap_v2_03(po,
