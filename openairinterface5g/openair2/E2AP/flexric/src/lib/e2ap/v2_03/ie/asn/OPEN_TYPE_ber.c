...
asn_dec_rval_t
OPEN_TYPE_ber_get_e2ap_v2_03(const asn_codec_ctx_t *opt_codec_ctx,
    ...
    if(*memb_ptr2 != NULL) {
        ...
        if(CHOICE_variant_set_presence_e2ap_v2_03(elm->type, *memb_ptr2, 0) != 0) {
            ASN__DECODE_FAILED;
        }
    }
    ...
    rv = selected.type_descriptor->op->ber_decode_e2ap_v2_03r(
