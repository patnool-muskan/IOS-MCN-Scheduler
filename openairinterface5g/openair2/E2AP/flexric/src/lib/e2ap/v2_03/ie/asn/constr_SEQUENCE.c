...
asn_TYPE_operation_t asn_OP_SEQUENCE_e2ap_v2_03 = {
    ...
    SEQUENCE_compare_e2ap_v2_03,
#if !defined(ASN_DISABLE_BER_SUPPORT)
    SEQUENCE_decode_ber_e2ap_v2_03,
    SEQUENCE_encode_der_e2ap_v2_03,
#else
    0,
    0,
#endif  /* !defined(ASN_DISABLE_BER_SUPPORT) */
#if !defined(ASN_DISABLE_XER_SUPPORT)
    SEQUENCE_decode_xer_e2ap_v2_03,
    SEQUENCE_encode_xer_e2ap_v2_03,
#else
    0,
    0,
    ...
    SEQUENCE_decode_uper_e2ap_v2_03,
    SEQUENCE_encode_uper_e2ap_v2_03,
#else
    0,
    0,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) */
#if !defined(ASN_DISABLE_APER_SUPPORT)
    SEQUENCE_decode_aper_e2ap_v2_03,
    SEQUENCE_encode_aper_e2ap_v2_03,
#else
    0,
    0,
#endif  /* !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_RFILL_SUPPORT)
    SEQUENCE_random_fill_e2ap_v2_03,
#else
    0,
...
void
SEQUENCE_free_e2ap_v2_03(const asn_TYPE_descriptor_t *td, void *sptr,
...
int
SEQUENCE_constraint_e2ap_v2_03(const asn_TYPE_descriptor_t *td, const void *sptr,
...
int
SEQUENCE_compare_e2ap_v2_03(const asn_TYPE_descriptor_t *td, const void *aptr,
                 const void *bptr) {
    size_t edx;
