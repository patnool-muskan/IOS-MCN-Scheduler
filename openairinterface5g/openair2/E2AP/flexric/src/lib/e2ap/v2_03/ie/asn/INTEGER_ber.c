 ...
 */
asn_enc_rval_t
INTEGER_encode_der_e2ap_v2_03(const asn_TYPE_descriptor_t *td, const void *sptr,
    ...
    rval = der_encode_e2ap_v2_03_primitive_e2ap_v2_03(td, st, tag_mode, tag, cb, app_key);
