...
asn_TYPE_operation_t asn_OP_SEQUENCE_e2ap_v1_01_OF = {
    SEQUENCE_OF_free,
    ...
    SEQUENCE_OF_compare_e2ap_v1_01,
#if !defined(ASN_DISABLE_BER_SUPPORT)
    SEQUENCE_OF_decode_ber,
    SEQUENCE_OF_encode_der_e2ap_v1_01,
#else
    0,
    0,
    ...
    SEQUENCE_OF_encode_xer_e2ap_v1_01,
#else
    0,
    0,
    ...
    SEQUENCE_OF_encode_uper_e2ap_v1_01,
#else
    0,
    0,
    ...
    SEQUENCE_OF_encode_aper_e2ap_v1_01,
#else
    0,
    0,
...
int
SEQUENCE_OF_compare_e2ap_v1_01(const asn_TYPE_descriptor_t *td, const void *aptr,
               const void *bptr) {
