...
OCTET_STRING__random_char(unsigned long lb, unsigned long ub) {
    assert(lb <= ub);
    switch(asn_random_between_e2ap_v1_01(0, 16)) {
    case 0:
    ...
    case 3:
        return ub;
    default:
        return asn_random_between_e2ap_v1_01(lb, ub);
    }
}

asn_random_fill_e2ap_v1_01_result_t
OCTET_STRING_random_fill_e2ap_v1_01(const asn_TYPE_descriptor_t *td, void **sptr,
    ...
    rnd_len =
        OCTET_STRING_random_length_constrained_e2ap_v1_01(td, constraints, max_length);
...
size_t
OCTET_STRING_random_length_constrained_e2ap_v1_01(
    ...
    rnd_len = lengths[asn_random_between_e2ap_v1_01(
        ...
        if(pc->flags & APC_CONSTRAINED) {
            ...
            if(pc->flags & APC_EXTENSIBLE) {
                ...
                case 2:
                    ...
                    /* Fall through */
                default:
                    rnd_len = asn_random_between_e2ap_v1_01(pc->lower_bound,
            ...
            rnd_len = asn_random_between_e2ap_v1_01(0, max_length);
        }
    } else {
#else
    if(!constraints) constraints = &td->encoding_constraints;
