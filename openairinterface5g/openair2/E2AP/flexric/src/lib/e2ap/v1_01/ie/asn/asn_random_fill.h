 ...
 */
typedef struct asn_random_fill_e2ap_v1_01_result_s {
    enum {
...
typedef asn_random_fill_e2ap_v1_01_result_t(asn_random_fill_e2ap_v1_01_f)(
 ...
 */
int asn_random_fill_e2ap_v1_01(const struct asn_TYPE_descriptor_s *td, void **struct_ptr,
                    size_t approx_max_length_limit);

/*
 * Returns a random number between min and max.
 */
intmax_t asn_random_between_e2ap_v1_01(intmax_t min, intmax_t max);
