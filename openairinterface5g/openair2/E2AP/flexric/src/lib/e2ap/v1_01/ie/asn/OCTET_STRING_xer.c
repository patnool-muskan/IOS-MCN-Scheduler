...
asn_enc_rval_t
OCTET_STRING_encode_xer_e2ap_v1_01(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_enc_rval_t
OCTET_STRING_encode_xer_e2ap_v1_01_utf8(const asn_TYPE_descriptor_t *td, const void *sptr,
                             int ilevel, enum xer_encode_e2ap_v1_01r_flags_e flags,
                             asn_app_consume_bytes_f *cb, void *app_key) {
    const OCTET_STRING_t *st = (const OCTET_STRING_t *)sptr;
    asn_enc_rval_t er = { 0, 0, 0 };
...
OCTET_STRING__decode_xer(
    ...
    return xer_decode_e2ap_v1_01_general(opt_codec_ctx, ctx, *sptr, xml_tag,
                              buf_ptr, size,
 ...
 */
asn_dec_rval_t
OCTET_STRING_decode_xer_hex_e2ap_v1_01(const asn_codec_ctx_t *opt_codec_ctx,
 ...
 */
asn_dec_rval_t
OCTET_STRING_decode_xer_binary_e2ap_v1_01(const asn_codec_ctx_t *opt_codec_ctx,
                               const asn_TYPE_descriptor_t *td, void **sptr,
                               const char *opt_mname, const void *buf_ptr,
                               size_t size) {
    return OCTET_STRING__decode_xer(opt_codec_ctx, td, sptr, opt_mname,
 ...
 */
asn_dec_rval_t
OCTET_STRING_decode_xer_utf8_e2ap_v1_01(const asn_codec_ctx_t *opt_codec_ctx,
                             const asn_TYPE_descriptor_t *td, void **sptr,
                             const char *opt_mname, const void *buf_ptr,
                             size_t size) {
    return OCTET_STRING__decode_xer(opt_codec_ctx, td, sptr, opt_mname,
