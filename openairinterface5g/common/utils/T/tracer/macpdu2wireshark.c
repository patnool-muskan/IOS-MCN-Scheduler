...
void nr_dl(void *_d, event e)
{
  ...
  trace_nr(d, NR_DIRECTION_DOWNLINK,
           (e.e[d->nr_dl_rnti].i != 0xFFFF) ? ((e.e[d->nr_dl_rnti].i != 0xFFFE) ? NR_C_RNTI : NR_P_RNTI) : NR_SI_RNTI,
...
void nr_ue_dl(void *_d, event e)
{
  ...
  trace_nr(d, NR_DIRECTION_DOWNLINK,
           (e.e[d->nr_ue_dl_rnti].i != 0xFFFF) ? ((e.e[d->nr_ue_dl_rnti].i != 0xFFFE) ? NR_C_RNTI : NR_P_RNTI) : NR_SI_RNTI,
