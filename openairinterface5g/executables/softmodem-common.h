...
#define CMDLINE_PARAMS_DESC {  \
  ...
  {"pdcp-drop",             CONFIG_HLP_PDCP_DROP,     PARAMFLAG_BOOL, .iptr=&PDCP_DROP,                        .defintval=1,            TYPE_INT,    0},  \
...
#define IS_SOFTMODEM_RESTAPI_ENABLED (get_softmodem_optmask()->bit.SOFTMODEM_RESTAPI_BIT)
...
typedef struct optmask_s {
  union {
    struct {
      ...
      uint64_t SOFTMODEM_RESTAPI_BIT: 1;
