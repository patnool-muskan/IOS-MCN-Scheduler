	...
	def BuildImage(self, HTML):
		...
		if result is not None:
			...
			if self.host == 'Ubuntu':
				...
				imageNames.append(('ran-build', 'build', 'ran-build-asan', '--build-arg "BUILD_OPTION=-DSANITIZE_ADDRESS=ON -DSANITIZE_UNDEFINED=ON"'))
				imageNames.append(('oai-enb', 'eNB', 'oai-enb-asan', '--build-arg "BUILD_OPTION=-DSANITIZE_ADDRESS=ON -DSANITIZE_UNDEFINED=ON"'))
				imageNames.append(('oai-gnb', 'gNB', 'oai-gnb-asan', '--build-arg "BUILD_OPTION=-DSANITIZE_ADDRESS=ON -DSANITIZE_UNDEFINED=ON"'))
				imageNames.append(('oai-lte-ue', 'lteUE', 'oai-lte-ue-asan', '--build-arg "BUILD_OPTION=-DSANITIZE_ADDRESS=ON -DSANITIZE_UNDEFINED=ON"'))
				imageNames.append(('oai-nr-ue', 'nrUE', 'oai-nr-ue-asan', '--build-arg "BUILD_OPTION=-DSANITIZE_ADDRESS=ON -DSANITIZE_UNDEFINED=ON"'))
				imageNames.append(('oai-nr-cuup', 'nr-cuup', 'oai-nr-cuup-asan', '--build-arg "BUILD_OPTION=-DSANITIZE_ADDRESS=ON -DSANITIZE_UNDEFINED=ON"'))
