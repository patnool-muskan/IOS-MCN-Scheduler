...
struct rte_ether_addr *p_ru_addr2 = (struct rte_ether_addr *)xranInit.p_o_ru_addr;
            struct rte_ether_addr *p_addr_test2;
            p_addr_test2 = &p_ru_addr2[1];
            printf("xran_init: remote DST MAC: %02"PRIx8" %02"PRIx8" %02"PRIx8" %02"PRIx8" %02"PRIx8" %02"PRIx8"\n",
                   p_addr_test2->addr_bytes[0], p_addr_test2->addr_bytes[1], p_addr_test2->addr_bytes[2],
                   p_addr_test2->addr_bytes[3], p_addr_test2->addr_bytes[4], p_addr_test2->addr_bytes[5]);
    printf("arg_params.num_vfs %d\n", arg_params.num_vfs);
