...
#define ORAN_CONFIG_RU_USERNAME "ru_username" // not needed if M-plane used
...
#define ORAN_GLOBALPARAMS_DESC { \
  ...
  {ORAN_CONFIG_RU_USERNAME,     "Username for RU\n",                        PARAMFLAG_MANDATORY, .strlistptr=NULL, .defstrlistval=(const char*[]){"root", NULL}, TYPE_STRINGLIST, 0}, \
