...
#ifdef UNI_RAN
#define GNB_CONFIG_STRING_RRC_INACTIVITY_TIMER          "inactivity_timer_threshold"
#define GNB_CONFIG_STRING_INACTIVITY_INTERVAL_SEC       "inactivity_interval_sec"
#define GNB_CONFIG_STRING_INACTIVITY_INTERVAL_US        "inactivity_interval_us"
#endif
/*-----------------------------------------------------------------------------------------------------------------------------------------*/
...
{GNB_CONFIG_STRING_RRC_INACTIVITY_TIMER,          NULL,  0,       .u64ptr=NULL,      .defint64val=0,              TYPE_UINT64,    0},  \
{GNB_CONFIG_STRING_INACTIVITY_INTERVAL_SEC,          NULL,  0,       .uptr=NULL,      .defuintval=1,              TYPE_UINT,      0},  \
{GNB_CONFIG_STRING_INACTIVITY_INTERVAL_US,          NULL,  0,       .uptr=NULL,      .defuintval=0,               TYPE_UINT,      0},  \
}
#else
#define GNBPARAMS_DESC {\
{GNB_CONFIG_STRING_GNB_ID,                       NULL,   0,           .uptr=NULL,   .defintval=0,                 TYPE_UINT,      0},  \
...
#ifdef UNI_RAN
#define GNB_RRC_INACTIVITY_TIMER        36
#define GNB_INACTIVITY_INTERVAL_SEC     37
#define GNB_INACTIVITY_INTERVAL_US      38
#endif
