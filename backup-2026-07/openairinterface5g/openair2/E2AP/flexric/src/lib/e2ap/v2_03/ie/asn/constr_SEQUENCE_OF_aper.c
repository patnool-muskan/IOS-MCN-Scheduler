...
asn_enc_rval_t
SEQUENCE_OF_encode_aper_e2ap_v2_03(const asn_TYPE_descriptor_t *td,
...
*/
    ...
    } else if (aper_put_length_e2ap_v2_03(po, ct->lower_bound, ct->upper_bound, list->count - ct->lower_bound, 0) < 0)
            ASN__ENCODE_FAILED;
    }
    ...
    for(seq = -1; seq < list->count;) {
        ...
        if(ct && ct->effective_bits >= 0) {
            ...
            mayEncode = aper_put_length_e2ap_v2_03(po, -1, -1, list->count - seq, &need_eom);
