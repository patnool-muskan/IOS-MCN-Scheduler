...
INTEGER__xer_body_decode(const asn_TYPE_descriptor_t *td, void *sptr,
    ...
    case ST_DIGITS_TRAILSPACE:
        ...
        switch(asn_strtoimax_lim_e2ap_v2_03(dec_value_start, &dec_value_end, &dec_value)) {
        case ASN_STRTOX_OK:
     ...
     */
    if(asn_imax2INTEGER_e2ap_v2_03(st, dec_value)) {
...
asn_dec_rval_t
INTEGER_decode_xer_e2ap_v2_03(const asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t
INTEGER_encode_xer_e2ap_v2_03(const asn_TYPE_descriptor_t *td, const void *sptr,
    ...
    er.encoded = INTEGER__dump_e2ap_v2_03(td, st, cb, app_key, 1);
