...
#else
typedef void (asn_random_fill_e2ap_v1_01_f)(void);
...
asn_outmost_tag_f asn_TYPE_outmost_tag_e2ap_v1_01;
...
typedef struct asn_TYPE_operation_s {
    ...
    ber_type_decoder_f *ber_decode_e2ap_v1_01r;      /* Generic BER decoder */
    der_type_encoder_f *der_encode_e2ap_v1_01r;      /* Canonical DER encoder */
    xer_type_decoder_f *xer_decode_e2ap_v1_01r;      /* Generic XER decoder */
    xer_type_encoder_f *xer_encode_e2ap_v1_01r;      /* [Canonical] XER encoder */
    jer_type_encoder_f *jer_encoder;      /* Generic JER encoder */
    oer_type_decoder_f *oer_decoder;      /* Generic OER decoder */
    oer_type_encoder_f *oer_encoder;      /* Canonical OER encoder */
    per_type_decoder_f *uper_decode_e2ap_v1_01r;     /* Unaligned PER decoder */
    per_type_encoder_f *uper_encode_e2ap_v1_01r;     /* Unaligned PER encoder */
    per_type_decoder_f *aper_decode_e2ap_v1_01r;     /* Aligned PER decoder */
    per_type_encoder_f *aper_encode_e2ap_v1_01r;     /* Aligned PER encoder */
    asn_random_fill_e2ap_v1_01_f *random_fill;       /* Initialize with a random value */
 ...
 * (See also xer_fprint_e2ap_v1_01() in xer_encode_e2ap_v1_01r.h)
 */
int asn_fprint_e2ap_v1_01(FILE *stream, /* Destination stream descriptor */
