...
asn_TYPE_operation_t asn_OP_CHOICE_e2ap_v2_03 = {
    ...
    CHOICE_compare_e2ap_v2_03,
#if !defined(ASN_DISABLE_BER_SUPPORT)
    CHOICE_decode_ber_e2ap_v2_03,
    CHOICE_encode_der_e2ap_v2_03,
#else
    0,
    0,
#endif  /* !defined(ASN_DISABLE_BER_SUPPORT) */
#if !defined(ASN_DISABLE_XER_SUPPORT)
    CHOICE_decode_xer_e2ap_v2_03,
    CHOICE_encode_xer_e2ap_v2_03,
#else
    0,
    0,
    ...
    CHOICE_decode_uper_e2ap_v2_03,
    CHOICE_encode_uper_e2ap_v2_03,
#else
    0,
    0,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) */
#if !defined(ASN_DISABLE_APER_SUPPORT)
    CHOICE_decode_aper_e2ap_v2_03,
    CHOICE_encode_aper_e2ap_v2_03,
#else
    0,
    0,
#endif  /* !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_RFILL_SUPPORT)
    CHOICE_random_fill_e2ap_v2_03,
#else
    0,
#endif  /* !defined(ASN_DISABLE_RFILL_SUPPORT) */
    CHOICE_outmost_tag_e2ap_v2_03
};

ber_tlv_tag_t
CHOICE_outmost_tag_e2ap_v2_03(const asn_TYPE_descriptor_t *td, const void *ptr, int tag_mode, ber_tlv_tag_t tag) {
     ...
     */
    present = _fetch_present_idx_e2ap_v2_03(ptr, specs->pres_offset, specs->pres_size);
    ...
    if(present > 0 && present <= td->elements_count) {
        ...
        return asn_TYPE_outmost_tag_e2ap_v2_03(elm->type, memb_ptr,
...
int
CHOICE_constraint_e2ap_v2_03(const asn_TYPE_descriptor_t *td, const void *sptr,
...
void
CHOICE_free_e2ap_v2_03(const asn_TYPE_descriptor_t *td, void *ptr,
 ...
 */
unsigned
_fetch_present_idx_e2ap_v2_03(const void *struct_ptr, unsigned pres_offset,
                   unsigned pres_size) {
...
void
_set_present_idx_e2ap_v2_03(void *struct_ptr, unsigned pres_offset, unsigned pres_size,
                 unsigned present) {
    void *present_ptr;
...
int
CHOICE_compare_e2ap_v2_03(const asn_TYPE_descriptor_t *td, const void *aptr, const void *bptr) {
 ...
 */
unsigned
CHOICE_variant_get_presence_e2ap_v2_03(const asn_TYPE_descriptor_t *td, const void *sptr) {
    const asn_CHOICE_specifics_t *specs =
        (const asn_CHOICE_specifics_t *)td->specifics;
    return _fetch_present_idx_e2ap_v2_03(sptr, specs->pres_offset, specs->pres_size);
}
 ...
 */
int
CHOICE_variant_set_presence_e2ap_v2_03(const asn_TYPE_descriptor_t *td, void *sptr,
                            unsigned present) {
    const asn_CHOICE_specifics_t *specs =
        (const asn_CHOICE_specifics_t *)td->specifics;
    ...
    old_present =
        _fetch_present_idx_e2ap_v2_03(sptr, specs->pres_offset, specs->pres_size);
    ...
    _set_present_idx_e2ap_v2_03(sptr, specs->pres_offset, specs->pres_size, present);
