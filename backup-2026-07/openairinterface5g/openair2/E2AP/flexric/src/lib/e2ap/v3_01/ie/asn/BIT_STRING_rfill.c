...
BIT_STRING_random_fill_e2ap_v3_01(const asn_TYPE_descriptor_t *td, void **sptr,
    ...
    rnd_bits = lengths[asn_random_between_e2ap_v3_01(
        ...
        if(pc->flags & APC_CONSTRAINED) {
            ...
            if(pc->flags & APC_EXTENSIBLE) {
                ...
                case 2:
                    ...
                    /* Fall through */
                default:
                    rnd_bits = asn_random_between_e2ap_v3_01(pc->lower_bound,
            ...
            rnd_bits = asn_random_between_e2ap_v3_01(0, max_length - 1);
        }
    } else {
#else
    ...
    for(b = buf; b < bend; b++) {
        *(uint8_t *)b = asn_random_between_e2ap_v3_01(0, 255);
    }
