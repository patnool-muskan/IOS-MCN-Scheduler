 ...
 */
asn_dec_rval_t
OCTET_STRING_decode_ber_e2ap_v3_01(const asn_codec_ctx_t *opt_codec_ctx,
    ...
    case 0:
         ...
         * Check tags.
         */
        rval = ber_check_tags_e2ap_v3_01(opt_codec_ctx, td, ctx,
    ...
    phase1:
        ...
        do {
            ...
            tl = ber_fetch_tag_e2ap_v3_01(buf_ptr, Left, &tlv_tag);
            ...
            ll = ber_fetch_length_e2ap_v3_01(tlv_constr,
                                  (const char *)buf_ptr + tl,Left - tl,&tlv_len);
            ASN_DEBUG("Got tag=%s, tc=%d, left=%ld, tl=%ld, len=%ld, ll=%ld",
                      ber_tlv_tag_string_e2ap_v3_01(tlv_tag), tlv_constr,
            ...
            if(tlv_tag != expected_tag) {
                char buf[2][32];
                ber_tlv_tag_snprint_e2ap_v3_01(tlv_tag,
                                    buf[0], sizeof(buf[0]));
                ber_tlv_tag_snprint_e2ap_v3_01(td->tags[td->tags_count-1],
                                    buf[1], sizeof(buf[1]));
 ...
 */
asn_enc_rval_t
OCTET_STRING_encode_der_e2ap_v3_01(const asn_TYPE_descriptor_t *td, const void *sptr,
     ...
     */
    if(type_variant != ASN_OSUBV_ANY || tag_mode == 1) {
        er.encoded = der_write_tags_e2ap_v3_01(td,
