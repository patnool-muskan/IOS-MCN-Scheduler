...
static asn_per_constraint_t asn_DEF_BIT_STRING_e2ap_v1_01_constraint_size = {
    APC_SEMI_CONSTRAINED, -1, -1, 0, 0};

asn_dec_rval_t
BIT_STRING_decode_uper_e2ap_v1_01(const asn_codec_ctx_t *opt_codec_ctx,
    ...
    if(pc) {
        ...
        csiz = &asn_DEF_BIT_STRING_e2ap_v1_01_constraint_size;
    }
...
asn_enc_rval_t
BIT_STRING_encode_uper_e2ap_v1_01(const asn_TYPE_descriptor_t *td,
    ...
    st = BIT_STRING__compactify_e2ap_v1_01(st, &compact_bstr);
    ...
    do {
        int need_eom = 0;
        ssize_t maySave = uper_put_length_e2ap_v1_01(po, size_in_bits, &need_eom);
