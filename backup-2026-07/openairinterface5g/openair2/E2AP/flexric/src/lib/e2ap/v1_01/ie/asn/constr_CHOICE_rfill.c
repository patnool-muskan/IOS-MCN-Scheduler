...
CHOICE_random_fill_e2ap_v1_01(const asn_TYPE_descriptor_t *td, void **sptr,
    ...
    present = asn_random_between_e2ap_v1_01(1, td->elements_count);
    ...
    _set_present_idx_e2ap_v1_01(st, specs->pres_offset, specs->pres_size, present);
