...
asn_per_constraints_t asn_PER_type_GlobalE2node_ID_constr_1_e2ap_v2_03 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  3 }	/* (0..3,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
asn_TYPE_member_t asn_MBR_GlobalE2node_ID_1_e2ap_v2_03[] = {
	{ ATF_POINTER, 0, offsetof(struct GlobalE2node_ID, choice.gNB),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_GlobalE2node_gNB_ID_e2ap_v2_03,
		0,
		{
	...
	{ ATF_POINTER, 0, offsetof(struct GlobalE2node_ID, choice.en_gNB),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_GlobalE2node_en_gNB_ID_e2ap_v2_03,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 0, offsetof(struct GlobalE2node_ID, choice.ng_eNB),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_GlobalE2node_ng_eNB_ID_e2ap_v2_03,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 0, offsetof(struct GlobalE2node_ID, choice.eNB),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_GlobalE2node_eNB_ID_e2ap_v2_03,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_CHOICE_specifics_t asn_SPC_GlobalE2node_ID_specs_1_e2ap_v2_03 = {
...
asn_TYPE_descriptor_t asn_DEF_GlobalE2node_ID_e2ap_v2_03 = {
	"GlobalE2node-ID",
	"GlobalE2node-ID",
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_GlobalE2node_ID_constr_1_e2ap_v2_03,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint_e2ap_v2_03
	},
	asn_MBR_GlobalE2node_ID_1_e2ap_v2_03,
	4,	/* Elements count */
	&asn_SPC_GlobalE2node_ID_specs_1_e2ap_v2_03	/* Additional specs */
};
