...
asn_dec_rval_t
OPEN_TYPE_uper_get_e2ap_v2_03(const asn_codec_ctx_t *opt_codec_ctx,
    ...
    rv = uper_open_type_get_e2ap_v2_03(opt_codec_ctx, selected.type_descriptor, NULL,
                            &inner_value, pd);
    switch(rv.code) {
    case RC_OK:
...
asn_enc_rval_t
OPEN_TYPE_encode_uper_e2ap_v2_03(const asn_TYPE_descriptor_t *td,
    ...
    if(uper_open_type_put_e2ap_v2_03(elm->type, NULL, memb_ptr, po) < 0) {
        ASN__ENCODE_FAILED;
    }
