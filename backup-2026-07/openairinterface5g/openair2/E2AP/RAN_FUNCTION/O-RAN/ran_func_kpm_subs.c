...
static meas_record_lst_t fill_RRC_UE_ID(uint32_t gran_period_ms, cudu_ue_info_pair_t ue_info, const size_t ue_idx)
{
  meas_record_lst_t meas_record = {0};
...
static meas_record_lst_t fill_RRU_Load(uint32_t gran_period_ms)
{
  meas_record_lst_t meas_record = {0};
