...
typedef struct pdusession_s {
  ...
  /* DL Tunnel Endpoint Identifier on E1 */
  uint32_t gnb_e1_dl_teid;
  /* DL Transport Layer on E1 */
  transport_layer_addr_t gnb_e1_dl_addr;
...
#ifdef UNI_RAN
/** 9.2.3.13 Uplink RAN Status Transfer (3GPP TS 38.413)
