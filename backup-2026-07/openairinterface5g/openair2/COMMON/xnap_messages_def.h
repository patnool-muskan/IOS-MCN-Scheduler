...
MESSAGE_DEF(XNAP_SN_STATUS_TRANSFER,MESSAGE_PRIORITY_MED, xnap_xn_sn_status_transfer_t, xnap_xn_sn_status_transfer) /* Xn code for SN Status transfer procedures */
