...
#define CONFIG_STRING_RU_TX_ANT                    "tx_ant"
#define CONFIG_STRING_RU_RX_ANT                    "rx_ant"
...
#define RUPARAMS_DESC { \
  ...
  {CONFIG_STRING_RU_TX_ANT,                    NULL,                              0,       .strptr=NULL,     .defstrval="",                TYPE_STRING,      0}, \
  {CONFIG_STRING_RU_RX_ANT,                    NULL,                              0,       .strptr=NULL,     .defstrval="",                TYPE_STRING,      0}, \
}
// clang-format on
